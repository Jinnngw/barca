      ...
      <div class="container">
        <div class="header-content">
          <div class="logo-section">
            <img src="/logo.svg" alt="AI角色扮演" class="logo" />
...
export default {
  ...
  setup() {
    ...
    const goToChat = (characterId) => {
      ...
      const sessionId = sessionIdMap[characterId] || 'default'
      
      console.log('跳转到聊天页面 - characterId:', characterId, 'sessionId:', sessionId)
      router.push({ name: 'Chat', params: { characterId, sessionId } })
    }
